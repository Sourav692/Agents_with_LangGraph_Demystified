# LangGraph AI Agent Projects

This folder contains hands-on projects organized by difficulty level, building progressively complex AI agent systems using LangGraph.
...
### 02-Intermediate
Projects that combine multiple concepts and introduce more complex patterns.

| Project | Description | Key Concepts |
|---------|-------------|--------------|
| **Multi_User_Conversational_Financial_Agent** | Multi-user conversational agent with memory | Memory, Threads, Multi-user sessions |
...
| Project | Description | Key Concepts |
|---------|-------------|--------------|
| **Hotel_Reservations_Multi_Agent_System** | Full hotel reservation system with multiple agents | Multi-agent orchestration, Error handling, Multi-language |
| **Software_Engineering_Multi_Agent_System** | Developer vs Tester agents for software engineering | Multi-actor systems, Agent collaboration |
...
4. Explore **04-Full-Stack-Projects** to see complete production-ready implementations
